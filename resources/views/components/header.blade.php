<header
    class="fixed top-0 left-0 right-0 z-50 glass-dark transition-all duration-500"
    x-data="{ 
        mobileOpen: false, 
        scrolled: false, 
        activeDropdown: null,
    ...
    :class="scrolled ? 'shadow-2xl shadow-black/10' : 'shadow-lg shadow-black/5'">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20 lg:h-24">
            ...
            {{-- Mobile Toggle --}}
            <button @click="mobileOpen = !mobileOpen" :aria-expanded="mobileOpen.toString()" aria-controls="mobile-navigation" aria-label="Toggle navigation menu" class="lg:hidden w-11 h-11 rounded-xl flex items-center justify-center transition-all duration-300 bg-white/10 text-white">
