...
<section class="min-h-[calc(100vh-8rem)] bg-gray-50 lg:grid lg:grid-cols-2">
    ...
    <div class="relative hidden lg:flex flex-col justify-between overflow-hidden bg-surface-950 p-12 text-white">
        ...
        <div class="relative max-w-md">
            ...
            <p class="mt-4 text-white/70 leading-relaxed">Join thousands of photographers and e-commerce teams who trust PhotoLabe with their images.</p>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
                ...
                <form method="POST" action="{{ route('register.post') }}" class="space-y-5">
                    ...
                    <p class="text-xs text-gray-400 text-center leading-relaxed">
                        ...
                        <a href="#" class="text-gray-700 font-semibold underline decoration-gray-300 underline-offset-2 hover:text-gray-900">Terms</a> and
                        <a href="#" class="text-gray-700 font-semibold underline decoration-gray-300 underline-offset-2 hover:text-gray-900">Privacy Policy</a>.
                    </p>
                </form>
            </div>
