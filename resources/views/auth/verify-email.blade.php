...
<section class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4">
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
            ...
            <div class="mb-6">
                <svg class="w-16 h-16 mx-auto text-indigo-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <form method="POST" action="{{ route('verification.send') }}">
                @csrf
                <button type="submit" class="w-full px-6 py-3 bg-indigo-600 text-white font-semibold rounded-full hover:bg-indigo-700 transition-colors mb-3">
