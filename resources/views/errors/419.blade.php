...
<title>Session Expired — {{ config('app.name', 'PhotoLabe') }}</title>
<style>
    ...
    .code{font-size:72px;font-weight:800;letter-spacing:-.03em;background:linear-gradient(135deg,#f59e0b,#ef4444);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;margin:0}
...
<body>
    <div class="card">
        ...
        <p>Your session has expired for security reasons. Please go back, refresh the page, and try again.</p>
