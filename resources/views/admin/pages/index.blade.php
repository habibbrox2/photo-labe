...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('admin.pages.create') }}" class="px-4 py-2 bg-primary-600 text-white text-sm font-semibold rounded-lg hover:bg-primary-700">+ Add Page</a>
</div>
...
<div class="bg-white rounded-xl border border-gray-200">
    ...
    <table class="w-full text-sm min-w-[640px]">
        ...
        <tbody class="divide-y divide-gray-100">
            ...
            @empty
                <tr><td colspan="6"><x-empty-state icon="document" title="No pages found" description="Create pages for content that doesn't fit a standard section."><a href="{{ route('admin.pages.create') }}" class="btn btn-primary btn-sm">Create a page</a></x-empty-state></td></tr>
            @endforelse
        </tbody>
    </table>
    </div>
