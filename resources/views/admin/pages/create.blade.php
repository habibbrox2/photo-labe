    ...
    <form method="POST" action="{{ route('admin.pages.store') }}" enctype="multipart/form-data">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
            <div class="bg-primary-50/60 rounded-lg px-4 py-3 text-sm text-gray-700 border border-primary-100">
                ...
                — Create a standalone site page. Upload one <strong>featured image</strong> — used as the page hero image. The block editor below lets you add rich content sections.
            </div>
            <div>
