    ...
    <form method="POST" action="{{ route('admin.before-after.update', $project) }}" enctype="multipart/form-data">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
            <div class="bg-primary-50/60 rounded-lg px-4 py-3 text-sm text-gray-700 border border-primary-100">
                ...
                — Update this before/after slider. Upload new before/after images to replace the existing ones.
            </div>
            <div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    @endif
                    <input type="file" name="before_image" accept="image/*" placeholder="JPG, PNG or WebP — max 5 MB" class="w-full px-4 py-2.5 rounded-lg border border-gray-200 text-sm file:mr-4 file:py-1 file:px-3 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-primary-50 file:text-primary-600">
                </div>
                <div>
                    ...
                    @endif
                    <input type="file" name="after_image" accept="image/*" placeholder="JPG, PNG or WebP — max 5 MB" class="w-full px-4 py-2.5 rounded-lg border border-gray-200 text-sm file:mr-4 file:py-1 file:px-3 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-primary-50 file:text-primary-600">
                </div>
            </div>
            <div>
                ...
                <p class="text-xs text-gray-400 mt-1">Embed this slider in any page, service, product, or portfolio content using <code class="font-mono">[before_after id={{ $project->id }}]</code></p>
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div>
