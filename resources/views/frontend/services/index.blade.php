    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div x-show="activeCategory === 'all' || activeCategory === '{{ $service->category->slug ?? '' }}'"
                ...
                <a href="{{ route('services.show', $service->slug) }}" class="group card-hover surface-card block overflow-hidden h-full">
                    ...
                    <div class="p-6">
                        <div class="text-xs font-bold text-primary-600 uppercase tracking-wider mb-2">{{ $service->category->name ?? '' }}</div>
